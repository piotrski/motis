...
/**
 * Get a trip with exact-second selected predictions
 */
export const tripV6 = <ThrowOnError extends boolean = false>(options: Options<TripV6Data, ThrowOnError>) => {
    return (options?.client ?? client).get<TripV6Response, TripV6Error, ThrowOnError>({
        ...options,
        url: '/api/v6/trip'
    });
};
...
/**
 * Get exact-second selected departures or arrivals
 */
export const stoptimesV6 = <ThrowOnError extends boolean = false>(options?: Options<StoptimesV6Data, ThrowOnError>) => {
    return (options?.client ?? client).get<StoptimesV6Response, StoptimesV6Error, ThrowOnError>({
        ...options,
 ...
 * is optional. Unmatched positions are omitted by default and can be
 * included with `includeUnmatched` for feed-quality inspection. Positions
 * older than the server's realtime freshness window are omitted.
 *
 */
export const vehicles = <ThrowOnError extends boolean = false>(options: Options<VehiclesData, ThrowOnError>) => {
    return (options?.client ?? client).get<VehiclesResponse, VehiclesError, ThrowOnError>({
        ...options,
        url: '/api/v1/map/vehicles'
    });
};
...
export const health = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<HealthResponse2, HealthError, ThrowOnError>({
        ...options,
        url: '/api/v1/health'
    });
};
