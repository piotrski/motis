...
private:
  ...
  hash_map<vehicle_key, history_entry, vehicle_key_hash> histories_;
  hash_map<vehicle_key, vehicle_observation, vehicle_key_hash> current_;
  hash_map<entity_key, vehicle_key, entity_key_hash> key_by_entity_;
};
