...
enum class vehicle_prediction_event_type { kArrival, kDeparture };
...
struct vehicle_prediction_stop_event {
  unsigned static_stop_sequence_{};
  std::int64_t scheduled_arrival_timestamp_seconds_{};
  std::int64_t scheduled_departure_timestamp_seconds_{};
};
...
struct vehicle_prediction_policy {
  ...
  // Provider publication cadence can be slower than our polling cadence. This
  // separately bounds the interval across which motion may be inferred.
